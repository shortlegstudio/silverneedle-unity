...
namespace ShortLegStudio.Dice
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShortLegStudio.Dice.Die"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.Dice.Die"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.Dice.Die"/>.</returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="System.Object"/> is equal to the current <see cref="ShortLegStudio.Dice.Die"/>.
        /// This requires the dice to be the same type and have the same roll
        /// </summary>
        /// <param name="obj">The <see cref="System.Object"/> to compare with the current <see cref="ShortLegStudio.Dice.Die"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="System.Object"/> is equal to the current
        /// <see cref="ShortLegStudio.Dice.Die"/>; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Serves as a hash function for a <see cref="ShortLegStudio.Dice.Die"/> object.
        /// </summary>

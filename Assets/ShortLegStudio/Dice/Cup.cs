...
namespace ShortLegStudio.Dice
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShortLegStudio.Dice.Cup"/> class.
        /// </summary>
        public Cup()
        {
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.Dice.Cup"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.Dice.Cup"/>.</returns>

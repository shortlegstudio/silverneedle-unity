...
namespace ShortLegStudio.RPG.Characters
{
    ...
    public class OffenseStats : IStatTracker
    {
        ...
        public struct AttackStatistic
        {
            ...
            /// <summary>
            /// Returns a <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.RPG.Characters.OffenseStats+AttackStatistic"/>.
            /// </summary>
            /// <returns>A <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.RPG.Characters.OffenseStats+AttackStatistic"/>.</returns>

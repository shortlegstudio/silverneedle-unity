...
namespace ShortLegStudio.RPG
{
    ...
    public class BasicStat
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShortLegStudio.RPG.BasicStat"/> class.
        /// </summary>
        public BasicStat()
        {
        ...
        { 
            get
            { 
                return (int)this.statModifiers.Sum(x => x.Modifier); 
            }
        }
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.RPG.BasicStat"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="ShortLegStudio.RPG.BasicStat"/>.</returns>
